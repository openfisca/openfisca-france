...
def test_cotsoc():
    ...
    cotsoc_cap = {
        ...
        # test sur le Revenus imposables des titres non côtés détenus dans le PEA et distributions perçues via votre
        # entreprise donnant droit à abattement (2fu)
        "f2fu": [
            {
                "amount": 20000,
                "vars": {
        ...
        # Autres revenus distribués et revenus des structures soumises hors de France à un régime fiscal privilégié
        # (2Go)
        "f2go": [
            {
                "amount": 20000,
        ...
        for item in test_list:
            ...
            for var, value in item["vars"].iteritems():
                ...
                if not passed:
                    assert_true(
                        passed,
                        u"Test failed for variable {} on year {}: \n OpenFisca value: {} \n Real value: {} \n".format(
