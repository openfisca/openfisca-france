...
def create_page_from_inputs(browser):
    ...
    inputs_radio = [input for input in inputs if input.get_attribute("type") == "radio"]
...
sitChoAlloc = Question(
    "sitChoAlloc", ["are", "ass", "ata", "aca", "asr", "autind", "attind", "allnok"]
)
...
page_rev = Page([revPercuSeul, chomPercuSeul, ressPercuSeul, pfPercuSeul, BCContinuer])


logement = Formulaire(
    url, [Page([]), page0, page1, page2, page3, page4, page5, page6, page7, page8]
)
