...
def get_indice(variable, period, categorie_salarie, corps, grade, echelon):
    ...
    # assert (
    #     np.logical_or(categorie_salarie == 4, categorie_salarie == 5) is True
    #     ).all(), "Bad categorie_salarie: {}".format(categorie_salarie)
    ...
    # assert (
    #     np.logical_and(echelon >= test_grid['echelon'].min(), echelon <= test_grid['echelon'].max())
    #     ).all(), "Bad echelon: {}".format(echelon)
