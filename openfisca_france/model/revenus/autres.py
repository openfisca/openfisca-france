...
class f8td(Variable):
    ...
    value_type = bool
    entity = FoyerFiscal
    label = "Contribution exceptionnelle sur les hauts revenus : vos revenus non passibles de l'impôt sur le revenu en France excèdent 50 % de vos revenus mondiaux au titre des deux années précédant celle de l'année d'imposition"
