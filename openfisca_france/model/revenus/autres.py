...
build_column('pensions_alim_percues', IntCol(label = u"Pensions alimentaires perçues",
               val_type = "monetary",
...
build_column('pensions_alim_percues_decl', BoolCol(label = u"Pension déclarée", default = True))
