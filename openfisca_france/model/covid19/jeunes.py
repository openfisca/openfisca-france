...
class aide_jeunes_diplomes_anciens_boursiers_base_ressources(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        nombre_mensualites = parameters(period).prestations_sociales.educatuion_culture.bourses.bourses_enseignement_superieur.criteres_sociaux.nombre_mensualites
