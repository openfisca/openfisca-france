...
class cf_enfant_eligible(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        condition_jeune = (age >= pfam.enfants.age_intermediaire) * (
            age < pfam.cf.age_max
        )
...
class cf_dom_enfant_eligible(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        condition_age = (age >= pfam.cf.age_minimal_dom) * (
            age < pfam.cf.age_maximal_dom
        )
...
class cf_plafond(Variable):
    ...
    def formula(famille, period, parameters):
        ...
        taux_plafond_metropole = (
            1
            + pfam.cf.majoration_plafond_2_premiers_enf * min_(cf_nbenf, 2)
            + pfam.cf.majoration_plafond_3eme_enf_et_plus * max_(cf_nbenf - 2, 0)
        )
        ...
        plafond_metropole = (
            pfam.cf.plafond_de_ressources_0_enfant * taux_plafond_metropole
            + pfam.cf.majoration_plafond_biact_isole * majoration_plafond
        )
