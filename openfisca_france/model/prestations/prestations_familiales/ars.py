...
class ars(Variable):
    ...
    def formula(famille, period, parameters):
        ...
        septembre = (
            period.start.offset("first-of", "year").offset(9, "month").period("month")
        )
        ...
        enf_05 = nb_enf(
            famille,
            septembre,
            P.ars.age_entree_primaire - 1,
            P.ars.age_entree_primaire - 1,
        )  # 5 ans et 6 ans avant le 31 décembre
        # enf_05 = 0
        ...
        enf_primaire = enf_05 + nb_enf(
            famille, septembre, P.ars.age_entree_primaire, P.ars.age_entree_college - 1
        )
        enf_college = nb_enf(
            famille, septembre, P.ars.age_entree_college, P.ars.age_entree_lycee - 1
        )
        enf_lycee = nb_enf(
            famille, septembre, P.ars.age_entree_lycee, P.ars.age_sortie_lycee
        )
        ...
        ars = (arsnbenf > 0) * max_(
            0, arsbase - max_(0, (base_ressources - ars_plaf_res) / max_(1, arsnbenf))
        )
