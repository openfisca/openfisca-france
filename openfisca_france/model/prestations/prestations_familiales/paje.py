...
class paje_base(Variable):
    ...
    def formula_2004(famille, period, parameters):
        ...
        montant_taux_plein_2014_2018 = indice * paje.paje_cm.montant.allocation_base_taux_plein
        montant_taux_plein_apres_2018 = indice * paje.paje_cm.montant.allocation_base_taux_plein
