...
class autonomie_financiere(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        return salaire_net_mensualise >= (
            _P.prestations.prestations_familiales.af.seuil_rev_taux * smic_mensuel_brut
        )
...
class prestations_familiales_base_ressources_individu(Variable):
    ...
    def formula(individu, period):
        ...
        traitements_salaires_pensions_rentes = individu(
            "traitements_salaires_pensions_rentes", annee_fiscale_n_2
        )
...
class biactivite(Variable):
    ...
    def formula(famille, period, parameters):
        ...
        condition_ressource = (
            famille.members("prestations_familiales_base_ressources_individu", period)
            >= seuil_rev
        )
...
class div(Variable):
    ...
    def formula(individu, period):
        ...
        revenus_foyer_fiscal = (
            f3vc + f3ve + f3vg - f3vh + f3vl + f3vm + f3vt
...
class prestations_familiales_base_ressources(Variable):
    ...
    def formula(famille, period):
        ...
        enfant_a_charge_i = famille.members(
