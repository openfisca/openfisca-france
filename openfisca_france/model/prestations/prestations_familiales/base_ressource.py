...
class rev_coll(SimpleFormulaColumn):
    ...
    def function(self, simulation, period):
        ...
        # Quand rev_coll est calculé sur une année glissante, pensions_alim_versees_declarant1 est calculé sur l'année légale
        # correspondante.
        pensions_alim_versees_declarant1 = simulation.calculate('pensions_alim_versees_declarant1', period.offset('first-of'))
        ...
        # pensions_alim_versees_declarant1 is negative since it is paid by the declaree
        ...
        return period, (rto_net_declarant1 + rev_cap_lib + rev_cat_rvcm + fon + glo + pensions_alim_versees_declarant1 - f7ga - f7gb
