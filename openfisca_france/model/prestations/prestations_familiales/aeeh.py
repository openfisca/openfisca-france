        ...
        montant_par_enfant = (
            ...
            * (
                ...
                * (
                    ...
                    + (niveau_handicap == 2)
                    * (cpl["1ere_categorie"] + maj["2e_categorie"] * isole)
                    + (niveau_handicap == 3)
                    * (cpl["2e_categorie"] + maj["3e_categorie"] * isole)
                    + (niveau_handicap == 4)
                    * (cpl["3e_categorie"] + maj["4e_categorie"] * isole)
                    + (niveau_handicap == 5)
                    * (cpl["4e_categorie"] + maj["5e_categorie"] * isole)
