...
class aide_logement_base_ressources_individu(Variable):
    ...
    def formula_2021_01_01(individu, period, parameters):
        ...
        abatpro = parameters(period.last_year).impot_revenu.calcul_revenus_imposables.deductions.abatpro
    ...
    def formula_2018_01_01(individu, period, parameters):
        ...
        abatpro = parameters(period.n_2).impot_revenu.calcul_revenus_imposables.deductions.abatpro
        abattement_forfaitaire = round_(min_(max_(abatpro.taux * revenu_assimile_salaire, abatpro.min), abatpro.max))
...
class aide_logement_base_ressources_eval_forfaitaire(Variable):
    ...
    def formula(individu, period, parameters):
        def eval_forfaitaire_salaries():
            ...
            params_abattement = parameters(period).impot_revenu.calcul_revenus_imposables.deductions.abatpro
