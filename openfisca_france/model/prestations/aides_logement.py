...
class aide_logement_base_ressources_individu(Variable):
    ...
    def formula_2021_01_01(individu, period, parameters):
        ...
        abattement_forfaitaire = round_(min_(max_(P.abatpro.taux_abat_salaires * revenu_assimile_salaire, P.abatpro.min), P.abatpro.max))
        ...
        revenu_assimile_pension = max_(0, revenu_assimile_pension - round_(max_(P.abatpen.taux_abat_pensions * revenu_assimile_pension, P.abatpen.min)))
    ...
    def formula(individu, period, parameters):
        ...
        abattement_forfaitaire = round_(min_(max_(P.abatpro.taux_abat_salaires * revenu_assimile_salaire, abattement_minimum), P.abatpro.max))
    ...
    def formula(individu, period, parameters):
        def eval_forfaitaire_salaries():
            ...
            montant_abattement = round_(
                min_(
                    max_(P.abatpro.taux_abat_salaires * somme_salaires_mois_precedent, P.abatpro.min),
                    P.abatpro.max
                    )
                )
...
class aide_logement_R0(Variable):
    ...
    def formula(famille, period, parameters):
        ...
        abattement_pension_salaire = deductions.abatpro.taux_abat_salaires  # dit de 10 %
