...
class aide_logement_R0(Variable):
    ...
    def formula_2015_01_01(famille, period, parameters):
        ...
        R0 = (
            al.al_param_r0.cas_general.r0.taux_seul * not_(couple) * (al_nb_pac == 0)
            + al.al_param_r0.cas_general.r0.taux_couple * couple * (al_nb_pac == 0)
            + al.al_param_r0.cas_general.r0.taux1pac * (al_nb_pac == 1)
            + al.al_param_r0.cas_general.r0.taux2pac * (al_nb_pac == 2)
            + al.al_param_r0.cas_general.r0.taux3pac * (al_nb_pac == 3)
            + al.al_param_r0.cas_general.r0.taux4pac * (al_nb_pac == 4)
            + al.al_param_r0.cas_general.r0.taux5pac * (al_nb_pac == 5)
            + al.al_param_r0.cas_general.r0.taux6pac * (al_nb_pac >= 6)  # la dernière valeur est un montant additionnel à rajouter pour chaque pac au-delà de 6.
            + al.al_param_r0.cas_general.r0.taux_pac_supp * (al_nb_pac > 6) * (al_nb_pac - 6)
            )
