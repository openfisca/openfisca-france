...
class aide_logement_montant_brut(Variable):
    ...
    def formula_2016_07_01(famille, period, parameters):
        ...
        abattement_forfaitaire = parameters(period).prestations_sociales.aides_logement.autres.abattement_forfaitaire
    ...
    def formula(famille, period, parameters):
        ...
        * vos proches parents infirmes âgés de 22 ans ou plus (parents,
        ...
        def al_nb_adultes_handicapes():
            ...
            # Parametres
            plafond_ressource = parameters(period.n_2.stop).prestations_sociales.minima_sociaux.aspa.plafond_ressources_seul * 1.25
...
class aide_logement_base_ressources(Variable):
    ...
    def formula_2021_01_01(famille, period, parameters):
        ...
        abattement_ressources_enfant = parameters(period.n_2.stop).prestations_sociales.minima_sociaux.aspa.plafond_ressources_seul * 1.25
