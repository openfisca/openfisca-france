...
class reduction_loyer_solidarite_plafond_ressources(Variable):
    ...
    entity = Famille
    label = (
        u"Plafond de ressources pour le calcul de la réduction du loyer de solidarité"
    )
    reference = [
    ...
    def formula(famille, period, parameters):
        ...
        plafond_famille = (
            ...
            * (personnes_a_charge_al - 6)
            * plafond_ressources.majoration_par_pac_supp
        )
...
class reduction_loyer_solidarite_montant(Variable):
    ...
    reference = (
        u"https://www.legifrance.gouv.fr/eli/arrete/2018/2/27/TERL1801551A/jo/article_2"
    )
    definition_period = MONTH
    ...
    def formula(famille, period, parameters):
        ...
        montant_famille = (
            ...
            + (personnes_a_charge_al > 1)
            * (personnes_a_charge_al - 1)
            * montant.majoration_par_pac_supp
        )
        ...
        return select(
            ...
            [montant_personne_seule, montant_couple, montant_1pac],
