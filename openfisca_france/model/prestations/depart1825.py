...
class depart1825_eligibilite(Variable):
    ...
    def formula(individu, period, parameters):
        criteres_age = parameters(period).prestations_sociales.educatuion_culture.depart1825.age
        ...
        plafond_ressources = parameters(period).prestations_sociales.educatuion_culture.depart1825.plafond_ressources
...
class depart1825_montant_maximum(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        montant = parameters(period).prestations_sociales.educatuion_culture.depart1825.montant_maximum
