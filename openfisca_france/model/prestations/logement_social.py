...
class zone_logement_social(Variable):
    ...
    def formula(menage, period):
        ...
        return select(
            [in_paris_communes_limitrophes, in_idf],
            [
...
class CategorieMenageLogementSocial(Enum):
    __order__ = (
        "categorie_1 categorie_2 categorie_3 categorie_4 categorie_5 categorie_6"
    )
...
class logement_social_plafond_ressources(Variable):
    ...
    def formula(famille, period, parameters):
        ...
        personnes_a_charge_supplementaires = (personnes_a_charge > 4) * (
            personnes_a_charge - 4
        )

        plafond_ressources_par_categorie = logement_social.plafond_ressources.par_categorie_de_menage[
            categorie_menage
        ]
        par_personne_supplementaire = logement_social.plafond_ressources.par_personne_supplementaire[
            zone_logement_social
        ]

        return plafond_ressources_par_categorie[zone_logement_social] + (
            personnes_a_charge_supplementaires * par_personne_supplementaire
        )
...
class logement_social_eligible(Variable):
    ...
    def formula_2017(famille, period, parameters):
        ...
        logement_social_plafond_ressources = famille(
            "logement_social_plafond_ressources", period
        )
