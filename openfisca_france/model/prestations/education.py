...
class bourse_college_echelon(DatedVariable):
    ...
    def function_apres_2016(famille, period, legislation):
        ...
        juillet_n_2 = period.n_2.this_month.offset(6, u"month")
        ...
        return period, apply_thresholds(
            rfr,
            thresholds = [
                plafonds_echelon_3,
                plafonds_echelon_2,
...
class bourse_college(Variable):
    ...
    def function(famille, period, legislation):
        ...
        bmaf_1er_janvier = legislation(period.this_year.this_month).prestations.prestations_familiales.af.bmaf
        ...
        return period, nb_enfants_college * montant_par_enfant / 12
...
class bourse_lycee(DatedVariable):
    ...
    def function_apres_2016(famille, period, legislation):
        ...
        return period, nb_enfants_lycee * montant_par_enfant / 12
