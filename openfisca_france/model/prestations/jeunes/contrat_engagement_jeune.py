...
class contrat_engagement_jeune_montant_forfaitaire(Variable):
    ...
    def formula_2022_03_01(individu, period, parameters):
        parameters_montants = parameters(period).prestations_sociales.education_culture.contrat_engagement_jeune.montants
...
class contrat_engagement_jeune_eligibilite(Variable):
    ...
    def formula_2022_03_01(individu, period, parameters):
        ...
        params_age = parameters(period).prestations_sociales.education_culture.contrat_engagement_jeune.critere_age
...
class contrat_engagement_jeune(Variable):
    ...
    def formula_2022_03_01(individu, period, parameters):
        three_previous_months = period.last_3_months
        parameters_degressivite = parameters(period).prestations_sociales.education_culture.contrat_engagement_jeune.degressivite
