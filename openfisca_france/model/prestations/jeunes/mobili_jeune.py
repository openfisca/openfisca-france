...
class mobili_jeune(Variable):
    ...
    def formula_2012_07(individu, period, parameters):
        ...
        return where(
            reste_a_charge >= parameters(period).prestations_sociales.mobili_jeune.montant.minimum,
            eligibilite * min_(reste_a_charge, parameters(period).prestations_sociales.mobili_jeune.montant.maximum),
            0,
            )
...
class mobili_jeune_eligibilite(Variable):
    ...
    def formula_2012_07(individu, period, parameters):
        condition_age = individu("age", period) < parameters(period).prestations_sociales.mobili_jeune.age_maximum
