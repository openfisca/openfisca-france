...
class mobili_jeune(Variable):
    ...
    def formula_2022_06(individu, period, parameters):
        ...
        maximum = where(secteur_agricole, parameters(period).prestations_sociales.educatuion_culture.mobilite.mobili_jeune.montant.maximum.secteur_agricole, parameters(period).prestations_sociales.educatuion_culture.mobilite.mobili_jeune.montant.maximum.autres_secteurs)

        eligibilite = individu('mobili_jeune_eligibilite', period)

        return where(
            (reste_a_charge >= parameters(period).prestations_sociales.educatuion_culture.mobilite.mobili_jeune.montant.minimum) * eligibilite,
    ...
    def formula_2012_07(individu, period, parameters):
        ...
        return where(
            reste_a_charge >= parameters(period).prestations_sociales.educatuion_culture.mobilite.mobili_jeune.montant.minimum,
            eligibilite * min_(reste_a_charge, parameters(period).prestations_sociales.educatuion_culture.mobilite.mobili_jeune.montant.maximum.autres_secteurs),
            0,
            )
...
class mobili_jeune_eligibilite(Variable):
    ...
    def formula_2022_06(individu, period, parameters):
        condition_age = individu('age', period) < parameters(period).prestations_sociales.educatuion_culture.mobilite.mobili_jeune.age_maximum
