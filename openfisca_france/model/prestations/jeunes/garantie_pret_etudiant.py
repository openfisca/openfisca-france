...
class garantie_pret_etudiant_eligibilite(Variable):
    ...
    def formula_2020_06_08(individu, period, parameters):
        ...
        condition_age = (age <= parameters(period).prestations.aides_jeunes.garantie_pret_etudiant.age_max)
...
class garantie_pret_etudiant_condition_nationalite(Variable):
    ...
    def formula_2021_02_19(individu, period, parameters):
        ...
        duree_min_residence_continue_annees = parameters(period).prestations.aides_jeunes.garantie_pret_etudiant.duree_min_residence_continue_annees
