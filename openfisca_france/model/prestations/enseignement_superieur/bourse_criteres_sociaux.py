...
class bourse_criteres_sociaux(Variable):
    ...
    def formula(individu, period, parameters):
        montants = parameters(period).prestations_sociales.educatuion_culture.bourses.bourses_enseignement_superieur.criteres_sociaux.montants
...
class bourse_criteres_sociaux_eligibilite_nationalite(Variable):
    ...
    def formula_2004_07_21(individu, period, parameters):
        ...
        ressortissant_pays_eligible = sum([nationalite == str.encode(etat) for etat in parameters(period).prestations_sociales.educatuion_culture.bourses.bourses_enseignement_superieur.criteres_sociaux.nationalites_hors_eee])  # TOOPTIMIZE: string encoding into bytes array should be done at load time
...
class bourse_criteres_sociaux_eligibilite_age(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        age_maximum = parameters(period).prestations_sociales.educatuion_culture.bourses.bourses_enseignement_superieur.criteres_sociaux.age_maximum
...
class bourse_criteres_sociaux_etudiant_autonome(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        seuil_ressources = legislation.prestations_sociales.educatuion_culture.bourses.bourses_enseignement_superieur.criteres_sociaux.seuil_ressources_etudiant_autonome * smic_mensuel_net
...
class bourse_criteres_sociaux_points_de_charge_distance_domicile_familial(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        bareme = parameters(period).prestations_sociales.educatuion_culture.bourses.bourses_enseignement_superieur.criteres_sociaux.points_de_charge.distance_domicile_familial
...
class bourse_criteres_sociaux_points_de_charge_charges_familiale(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        pts = parameters(period).prestations_sociales.educatuion_culture.bourses.bourses_enseignement_superieur.criteres_sociaux.points_de_charge.charges_familiales
...
class bourse_criteres_sociaux_echelon(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        baremes = parameters(period).prestations_sociales.educatuion_culture.bourses.bourses_enseignement_superieur.criteres_sociaux.plafond_ressources
