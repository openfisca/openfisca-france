    ...
    def formula(individu, period, parameters):
        ...
        def abattement_salaire():
            ...
            abattement_forfaitaire_base = (
                leg_1er_janvier.marche_travail.salaire_minimum.smic.smic_b_horaire * parameters.marche_travail.salaire_minimum.smic.nb_heures_travail_mensuel
                )

            taux_abattement_forfaitaire = where(
                aspa_couple,
                parameters.prestations_sociales.solidarite_insertion.minimum_vieillesse.aspa.abattement_forfaitaire.couples,
                parameters.prestations_sociales.solidarite_insertion.minimum_vieillesse.aspa.abattement_forfaitaire.personnes_seules
                )
