...
class aide_mobilite_parcoursup(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        montant = parameters(period).prestations.aides_jeunes.mobilite.aide_mobilite_parcoursup.montant
...
class aide_mobilite_master(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        montant = parameters(period).prestations.aides_jeunes.mobilite.aide_mobilite_master.montant
