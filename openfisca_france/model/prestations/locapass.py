...
class locapass_eligibilite(Variable):
    ...
    def formula(individu, period, parameters):
        params = parameters(period).prestations.aides_logement.action_logement.locapass
...
class locapass_eligibilite_jeunes(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        age_max = parameters(period).prestations.aides_logement.action_logement.locapass.jeunes.age_max
