...
class mon_job_mon_logement_eligibilite_logement(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        params = parameters(period).prestations.aides_logement.mon_job_mon_logement
...
class mon_job_mon_logement_eligibilite_jeunes_actifs(Variable):
    ...
    def formula(individu, period, parameters):
        params = parameters(period).prestations.aides_logement.mon_job_mon_logement.jeune_actif
...
class mon_job_mon_logement(Variable):
    ...
    def formula(individu, period, parameters):
        montant = parameters(period).prestations.aides_logement.mon_job_mon_logement.montant
