...
class pass_culture(Variable):
    ...
    def formula(individu, period, parameters):
        montant = parameters(period).prestations_sociales.educatuion_culture.pass_culture.montants
        age = individu('age', period.offset(1, 'month'))
        age_maximum = parameters(period).prestations_sociales.educatuion_culture.pass_culture.age_maximum
