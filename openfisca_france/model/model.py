...
#        entity = 'foy')),
    ...
    build_simple_formula_couple('intagr', FloatCol(function = ri._intagr,
        entity = 'foy',
        start = date(2005, 1, 1))),
    build_simple_formula_couple('duflot', FloatCol(function = ri._duflot,
        entity = 'foy',
        start = date(2013, 1, 1))),
    ...
    build_dated_formula_couple('scelli',
        ...
        FloatCol(entity = 'foy')),
    build_dated_formula_couple('locmeu',
        [
         dict(start = date(2009, 1, 1),
              end = date(2009, 12, 31),
        ...
        FloatCol(entity = 'foy')),
    build_dated_formula_couple('doment',
        [
         dict(start = date(2005, 1, 1),
              end = date(2005, 12, 31),
        ...
        FloatCol(entity = 'foy')),
    build_dated_formula_couple('domsoc',
        [
         dict(start = date(2010, 1, 1),
              end = date(2012, 12, 31),
...
#        entity = 'foy')), #TODO : adrien transform as credit_impot
    ...
    build_dated_formula_couple('creimp',  #TODO: Change name to credits_impot (before, take care of imputations)
        ...
        FloatCol(entity = 'foy')),
    build_dated_formula_couple('accult',
     [
      dict(start = date(2002, 1, 1),
           end = date(2012, 12, 31),
           function = ci._accult,
    ...
    build_simple_formula_couple('direpa', FloatCol(function = ci._direpa,
        entity = 'foy')),
    build_dated_formula_couple('mecena',
     [
      dict(start = date(2003, 1, 1),
           end = date(2012, 12, 31),
           function = ci._mecena,
	...
	FloatCol(entity='foy')),
    build_simple_formula_couple('quaenv_bouquet', FloatCol(function = ci._quaenv_bouquet,
        entity = 'foy',
        start = date(2013, 1, 1))),
...
#    build_simple_formula_couple('alv', FloatCol(function = ir._alv)),
    ...
    build_simple_formula_couple('paje_base_temp', FloatCol(function = paje._paje_base,
        entity = 'fam',
        label = u"Allocation de base de la PAJE sans tenir compte d'éventuels cumuls",
        start = date(2004, 1, 1))),
    build_simple_formula_couple('paje_base', FloatCol(function = paje._paje_cumul,
        entity = 'fam',
    ...
    build_simple_formula_couple('paje_nais', FloatCol(function = paje._paje_nais,
        entity = 'fam',
        label = u"Allocation de naissance de la PAJE",
        start = date(2004, 1, 1),
        url = u"http://vosdroits.service-public.fr/particuliers/F2550.xhtml",
        )),
    build_simple_formula_couple('paje_clca', FloatCol(function = paje._paje_clca,
        entity = 'fam',
        label = u"PAJE - Complément de libre choix d'activité",
        start = date(2004, 1, 1),
        url = u"http://vosdroits.service-public.fr/particuliers/F313.xhtml",
        )),
    build_simple_formula_couple('paje_clca_taux_plein', BoolCol(function = paje._paje_clca_taux_plein,
        entity = 'fam',
        label = u"Indicatrice Clca taux plein",
        start = date(2004, 1, 1),
        url = u"http://vosdroits.service-public.fr/particuliers/F313.xhtml",
        )),
    build_simple_formula_couple('paje_clca_taux_partiel', BoolCol(function = paje._paje_clca_taux_partiel,
        entity = 'fam',
        label = u"Indicatrice Clca taux partiel",
        start = date(2004, 1, 1),
        url = u"http://vosdroits.service-public.fr/particuliers/F313.xhtml",
        )),
    build_simple_formula_couple('paje_colca', FloatCol(function = paje._paje_colca,
        entity = 'fam',
    ...
    build_simple_formula_couple('paje_clmg', FloatCol(function = paje._paje_clmg,
        entity = 'fam',
    ...
    build_simple_formula_couple('paje', FloatCol(function = paje._paje,
        entity = 'fam',
    ...
    build_simple_formula_couple('rsa_forfait_logement', FloatCol(function = rsa._rsa_forfait_logement,
        entity = 'fam')),
    ...
    build_simple_formula_couple('rsa_socle_majore', FloatCol(function = rsa._rsa_socle_majore,
        entity = 'fam',
