...
#    build_simple_formula_couple('alv', FloatPresta(ir._alv)),
    build_simple_formula_couple('glo', FloatPresta(ir._glo, label =u"Gain de levée d'options")),
    ...
    build_simple_formula_couple('psoc', FloatPresta(cm._psoc, entity = 'fam', label = u"Total des prestations sociales")),
    ...
    build_simple_formula_couple('pfam', FloatPresta(cm._pfam, entity = 'fam', label = u"Total des prestations familiales")),
    build_simple_formula_couple('mini', FloatPresta(cm._mini, entity = 'fam', label = u"Minima sociaux")),
    build_simple_formula_couple('logt', FloatPresta(cm._logt, entity = 'fam', label = u"Allocations logements")),
    build_simple_formula_couple('impo', FloatPresta(cm._impo, entity = 'men', label = u"Impôts sur le revenu")),
