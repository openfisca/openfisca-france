...
#        )),
    ...
    build_dated_formula_couple('deficit_rcm',
	[
   	 dict(start = date(2009, 1, 1),
	      end = date(2009, 12, 31),
	      function = ir._deficit_rcm_2009,
	     ),
   	 dict(start = date(2010, 1, 1),
	      end = date(2010, 12, 31),
	      function = ir._deficit_rcm_2010,
	     ),
   	 dict(start = date(2011, 1, 1),
	      end = date(2011, 12, 31),
	      function = ir._deficit_rcm_2011,
	     ),
   	 dict(start = date(2012, 1, 1),
	      end = date(2012, 12, 31),
	      function = ir._deficit_rcm_2012,
	     ),
   	 dict(start = date(2013, 1, 1),
	      end = date(2013, 12, 31),
	      function = ir._deficit_rcm_2013,
	     ),
   	 dict(start = date(2014, 1, 1),
	      end = date(2014, 12, 31),
	      function = ir._deficit_rcm_2014,
	     ),
	],
	FloatCol(entity='foy',
...
#                     ),
	...
	[
   	 ...
   	 dict(start = date(2010, 1, 1),
	      ...
	      function = ci._aidper_2010,
	     ),
   	 dict(start = date(2011, 1, 1),
	      end = date(2015, 12, 31),
	      function = ci._aidper_2011_,
	     ),
	],
	FloatCol(entity='foy')),
	...
	[
   	 ...
   	 dict(start = date(2010, 1, 1),
	      ...
	      function = ci._quaenv_2010,
	     ),
   	 dict(start = date(2011, 1, 1),
	      end = date(2015, 12, 31),
	      function = ci._quaenv_2011_,
	     ),
	],
	FloatCol(entity='foy')),
