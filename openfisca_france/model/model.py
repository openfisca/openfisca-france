...
prestation_by_name = collections.OrderedDict((
    ...
    build_simple_formula_couple('prelsoc_cap_bar', FloatCol(function = cs_capital._prelsoc_cap_bar,
    ...
    build_simple_formula_couple('prelsoc_fon', FloatCol(function = cs_capital._prelsoc_fon,
        entity = "foy",
    ...
    build_simple_formula_couple('prelsoc_pv_mo', FloatCol(function = cs_capital._prelsoc_pv_mo,
        entity = "foy",
    ...
    build_simple_formula_couple('prelsoc_pv_immo', FloatCol(function = cs_capital._prelsoc_pv_immo,
        entity = "foy",
...
#        )),
    ...
    build_simple_formula_couple('cd_acc75a', FloatCol(function = cd._cd_acc75a,
        entity = 'foy')),
    build_simple_formula_couple('cd_percap', FloatCol(function = cd._cd_percap,
        entity = 'foy',
        end = date(2006, 12, 31),
        start = date(2002, 1, 1),
        )),
	...
	[dict(start = date(2002, 1, 1),
             ...
             function = cd._cd1_2002,
             ),
         dict(start = date(2004, 1, 1),
             end = date(2005, 12, 31),
             function = cd._cd1_2004,
             ),
	 ...
	 dict(start = date(2007, 1, 1),
             ...
             function = cd._cd1_2007,
             ),
	 dict(start = date(2009, 1, 1),
             end = date(2013, 12, 31),
             function = cd._cd1_2009,
             ),
    ...
    build_simple_formula_couple('rev_cat_rvcm', FloatCol(function = ir._rev_cat_rvcm,
        entity = 'foy',
    ...
    build_simple_formula_couple('plus_values', FloatCol(function = ir._plus_values,
        entity = 'foy')),
...
#        entity = 'foy')),
    ...
    build_simple_formula_couple('cotsyn', FloatCol(function = ri._cotsyn,
        entity = 'foy')),
    build_simple_formula_couple('resimm', FloatCol(function = ri._resimm,
        entity = 'foy',
        start = date(2009, 1, 1))),
    build_simple_formula_couple('patnat', FloatCol(function = ri._patnat,
        entity = 'foy',
        start = date(2010, 1, 1))),
    build_simple_formula_couple('sofipe', FloatCol(function = ri._sofipe,
        entity = 'foy',
        start = date(2009, 1, 1))),
    build_simple_formula_couple('saldom', FloatCol(function = ri._saldom,
        entity = 'foy',
        start = date(2007, 1, 1))),
    ...
    build_simple_formula_couple('prcomp', FloatCol(function = ri._prcomp,
        entity = 'foy')),
    build_simple_formula_couple('spfcpi', FloatCol(function = ri._spfcpi,
        entity = 'foy')),
    ...
    build_simple_formula_couple('sofica', FloatCol(function = ri._sofica,
        entity = 'foy',
        start = date(2006, 1, 1))),
    build_simple_formula_couple('cappme', FloatCol(function = ri._cappme,
        entity = 'foy')),
    build_simple_formula_couple('repsoc', FloatCol(function = ri._repsoc,
        entity = 'foy',
        start = date(2003, 1, 1))),
    build_simple_formula_couple('invfor', FloatCol(function = ri._invfor,
        entity = 'foy')),
    ...
    build_simple_formula_couple('rsceha', FloatCol(function = ri._rsceha,
        entity = 'foy')),
    build_simple_formula_couple('invlst', FloatCol(function = ri._invlst,
        entity = 'foy',
        start = date(2004, 1, 1))),
    build_simple_formula_couple('domlog', FloatCol(function = ri._domlog,
        entity = 'foy',
        start = date(2002, 1, 1),
        end = date(2009, 12, 31))),
    build_simple_formula_couple('adhcga', FloatCol(function = ri._adhcga,
        entity = 'foy')),
    build_simple_formula_couple('creaen', FloatCol(function = ri._creaen,
        entity = 'foy',
        start = date(2006, 1, 1))),
    build_simple_formula_couple('ecpess', FloatCol(function = ri._ecpess,
        entity = 'foy')),
    build_simple_formula_couple('scelli', FloatCol(function = ri._scelli,
        entity = 'foy',
        start = date(2009, 1, 1),
        end = date(2010, 12, 31))),
    ...
    build_simple_formula_couple('garext', FloatCol(function = ri._garext,
        entity = 'foy',
        start = date(2002, 1, 1),
        end = date(2005, 12, 31))),
...
#        )), # PLF 2013, amendement rejeté
    build_simple_formula_couple('imp_lib', FloatCol(function = ir._imp_lib,
        entity = 'foy',
        url = u"http://www.impots.gouv.fr/portal/dgi/public/particuliers.impot?pageId=part_ctrb_soc&paf_dm=popup&paf_gm=content&typePage=cpr02&sfid=501&espId=1&impot=CS",
        end = date(2012, 12, 31)),),  # TODO: Check - de 2000euros
    ...
    build_simple_formula_couple('assiette_proflib', FloatCol(function = ir._micro_social_proflib,
        entity = 'foy',
        start = date(2009, 1, 1))),
    build_simple_formula_couple('microsocial', FloatCol(function = ir._micro_social,
        entity = 'foy',
...
#                     ),
    ...
    build_simple_formula_couple('aidper', FloatCol(function = ci._aidper,
        entity = 'foy')),
    build_simple_formula_couple('quaenv', FloatCol(function = ci._quaenv,
        entity = 'foy',
        start = date(2005, 1, 1))),
    ...
    build_simple_formula_couple('ci_garext', FloatCol(function = ci._ci_garext,
        entity = 'foy',
        start = date(2005, 1, 1))),
    build_simple_formula_couple('preetu', FloatCol(function = ci._preetu,
        entity = 'foy',
        start = date(2005, 1, 1))),
    build_simple_formula_couple('saldom2', FloatCol(function = ci._saldom2,
        entity = 'foy',
        start = date(2007, 1, 1))),
    build_simple_formula_couple('inthab', FloatCol(function = ci._inthab,
        entity = 'foy',
        start = date(2007, 1, 1))),
    ...
    build_simple_formula_couple('jeunes', FloatCol(function = ci._jeunes,
        entity = 'foy',
        start = date(2005, 1, 1),
        end = date(2008, 12, 31))),
...
#    build_simple_formula_couple('alv', FloatCol(function = ir._alv)),
    ...
    build_simple_formula_couple('rev_cap_lib', FloatCol(function = ir._rev_cap_lib,
        entity = 'foy',
        url = u"http://fr.wikipedia.org/wiki/Revenu#Revenu_du_Capital",
        )),
    ...
    build_simple_formula_couple('isf_iai', FloatCol(function = isf._isf_iai,
        entity = 'foy')),
    ...
    build_simple_formula_couple('revetproduits', FloatCol(function = isf._revetproduits,
        entity = 'foy')),
    build_simple_formula_couple('isf_apres_plaf', FloatCol(function = isf._isf_apres_plaf,
        entity = 'foy')),
    build_simple_formula_couple('decote_isf', FloatCol(function = isf._decote_isf,
        entity = 'foy',
        start = date(2013, 1, 1))),
    ...
    build_simple_formula_couple('aeeh', FloatCol(function = pf._aeeh,
        entity = 'fam',
    ...
    build_simple_formula_couple('crds_mini', FloatCol(function = ms._crds_mini,
        entity = 'fam',
        start = date(2009, 7, 1))),
    build_simple_formula_couple('aefa', FloatCol(function = ms._aefa,
        entity = 'fam',
    ...
    build_simple_formula_couple('caah', FloatCol(function = ms._caah,
        entity = 'fam',
