...
column_by_name = collections.OrderedDict((
    ...
    ('nbR', IntCol(label = u"Nombre de titulaires de la carte invalidité d'au moins 80 %",
                   entity = 'foy',
                   cerfa_field = u'R')),
    ('nbJ', IntCol(label = u"Nombre d'enfants majeurs célibataires sans enfant",
                   entity = 'foy',
                   cerfa_field = u'J')),
    ('nbI', IntCol(label = u"Nombre d'enfants à charge en résidence alternée titulaires de la carte d'invalidité",
                   entity = 'foy',
                   cerfa_field = u'I')),
    ('nbH', IntCol(label = u"Nombre d'enfants à charge en résidence alternée, non mariés de moins de 18 ans au 1er janvier de l'année n-1, ou nés en n-1 ou handicapés quel que soit l'âge",
                   entity = 'foy',
                   cerfa_field = u'H')),
# TODO: vérifier si c'est bien ça pour la nbH et la caseH qui suit
    ('nbG', IntCol(label = u"Nombre d'enfants à charge titulaires de la carte d'invalidité",
                   entity = 'foy',
                   cerfa_field = u'G')),
    ('nbF', IntCol(label = u"Nombre d'enfants à charge  non mariés de moins de 18 ans au 1er janvier de l'année n-1, ou nés en n-1 ou handicapés quel que soit l'âge",
                   entity = 'foy',
                   cerfa_field = u'F')),
    ...
    ('caseE', BoolCol(label = u"Situation pouvant donner droit à une demi-part supplémentaire: enfant élevé seul pendant moins de 5 ans",
                      entity = 'foy',
                      cerfa_field = u'E')),
    ('caseF', BoolCol(label = u"Situation pouvant donner droit à une demi-part supplémentaire: conjoint titulaire d'une pension ou d'une carte d'invalidité(vivant ou décédé l'année précédente",
                      entity = 'foy',
                      cerfa_field = u'F')),
