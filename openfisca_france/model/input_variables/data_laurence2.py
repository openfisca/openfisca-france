...
mais si les start-end fonctionne ça ne devrait pas avoir d'impact sur les calculs ? qu'en penses-tu ? 
    ...
    build_column_couple('f3vl', IntCol(entity = 'foy', 
                    ...
                    val_type = "monetary",
                    cerfa_field = u'3VL',
                    start =datetime.date(2012, 1, 1))),# vérifier pour 2011 et 2010
"""
    ...
    build_column_couple('f3vv', IntCol(entity = 'foy',
                    ...
                    val_type = "monetary",
                    cerfa_field = u'3VV',
                    start = datetime.date(2013, 1, 1))),  # TODO: à revoir :ok pour 2013, correspond à autre chose en 2009, vérifier 2010 et 2011
...
#    build_column_couple    ('f7wg', IntCol(entity = 'foy', label = u"Intérêts d'emprunts", val_type = "monetary", cerfa_field = u'7WG')), #TODO: cf pour quelle année
    ...
    build_column_couple('f7wq', IntCol(entity = 'foy',
                    ...
                    end = datetime.date(2012, 12, 31))),  # TODO: vérifier année de début
...
"""
    ...
    build_column_couple('f7cc', IntCol(entity = 'foy',
                    ...
                    val_type = "monetary",
                    cerfa_field = u'7CC',
                    start = datetime.date(2013, 1, 1))),  # TODO: nouvelle variable à intégrer dans OF
...
# """
    ...
    build_column_couple('f7uh', IntCol(entity = 'foy',
                    ...
                    val_type = "monetary",
                    cerfa_field = u'7UH',
                    end = datetime.date(2011, 12, 31))),  # verif <=2011
...
# """
    ...
    build_column_couple('f7xg', IntCol(entity = 'foy', label = u"Investissement locatif dans le secteur touristique, travaux réalisés dans un village résidentiel de tourisme",
                    val_type = "monetary",
                    cerfa_field = u'7XG',
                    end = datetime.date(2012, 12, 31))),  # vérif <=2011
...
# """
    ...
    build_column_couple('f8wv', IntCol(entity = 'foy',
                    ...
                    val_type = "monetary",
                    cerfa_field = u'8WV',
                    end = datetime.date(2012, 12, 31))),  # verif<=2011
...
# """
    ...
    build_column_couple('f7sd', IntCol(entity = 'foy',
                    ...
                    val_type = "monetary",
                    cerfa_field = u'7SD',
                    start = datetime.date(2012, 1, 1))),  # verif<=2011 et vérifier autres prog comportant f7sd
    ...
    build_column_couple('f7se', IntCol(entity = 'foy',
                    ...
                    val_type = "monetary",
                    cerfa_field = u'7SE',
                    start = datetime.date(2012, 1, 1))),  # verif<=2011 et vérifier autres prog comportant f7se
    ...
    build_column_couple('f7sh', IntCol(entity = 'foy',
                    ...
                    val_type = "monetary",
                    cerfa_field = u'7SH',
                    start = datetime.date(2012, 1, 1))),  # verif<=2011
...
# """
    ...
    build_column_couple('f7uq', IntCol(entity = 'foy',
                    ...
                    val_type = "monetary",
                    cerfa_field = u'7UQ',
                    start = datetime.date(2008, 1, 1))),  # vérif date début, ok pour 12 et 13
    ...
    build_column_couple('f1ar', IntCol(entity = 'foy',
                    ...
                    cerfa_field = u'1AR',
                    end = datetime.date(2011, 12, 31))),  # vérifier <=2011
    ...
    build_column_couple('f4tq', IntCol(entity = 'foy',
                    ...
                    val_type = "monetary",
                    cerfa_field = u'4TQ')),  # vérif libéllé, en 2013 et 2012=Montant des loyers courus du 01/01/1998 au 30/09/1998 provenant des immeubles
