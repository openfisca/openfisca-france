...
from openfisca_core.columns import BoolCol, EnumCol, IntCol, PeriodSizeIndependentIntCol, StrCol, FloatCol
...
build_column('depcom', StrCol(label = u"Code INSEE (depcom) du lieu de résidence", entity = 'men'))
