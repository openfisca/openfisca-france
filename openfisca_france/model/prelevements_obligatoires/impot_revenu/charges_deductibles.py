...
class f6ps(Variable):
    cerfa_field = {0: u"6PS", 1: u"6PT", 2: u"6PU"}
    value_type = int
    unit = "currency"
    entity = Individu
...
class f6rs(Variable):
    cerfa_field = {0: u"6RS", 1: u"6RT", 2: u"6RU"}
    value_type = int
    unit = "currency"
    entity = Individu
...
class f6ss(Variable):
    cerfa_field = {0: u"6SS", 1: u"6ST", 2: u"6SU"}
    value_type = int
    unit = "currency"
    entity = Individu
...
class cd1(Variable):
    ...
    def formula_2002_01_01(foyer_fiscal, period, parameters):
        ...
        cd_acc75a = foyer_fiscal("cd_acc75a", period)
        pertes_capital_societes_nouvelles = foyer_fiscal(
            "pertes_capital_societes_nouvelles", period
        )
...
class pensions_alimentaires_deduites(Variable):
    ...
    def formula(foyer_fiscal, period, parameters):
        ...
        penalim = parameters(
            period
        ).impot_revenu.charges_deductibles.pensions_alimentaires
...
class cd_acc75a(Variable):
    ...
    def formula(foyer_fiscal, period, parameters):
        ...
        acc75a = parameters(
            period
        ).impot_revenu.charges_deductibles.accueil_personne_agee
...
class pertes_capital_societes_nouvelles(Variable):
    ...
    def formula_2002_01_01(foyer_fiscal, period, parameters):
        ...
        percap = parameters(
            period
        ).impot_revenu.charges_deductibles.pertes_en_capital_societes_nouvelles
...
class cd_eparet(Variable):
    ...
    def formula_2004(foyer_fiscal, period, parameters):
        ...
        return foyer_fiscal.sum(
            where(f6ps_i == 0, f6rs_i + f6ss_i, min_(f6rs_i + f6ss_i, f6ps_i))
        )
...
class cd_sofipe(Variable):
    ...
    def formula_2002(foyer_fiscal, period, parameters):
        ...
        plafond = min_(
            sofipeche.plafond_pct_rng * rbg_int,
            sofipeche.plafond * (1 + maries_ou_pacses),
        )
...
class epargne_codeveloppement(Variable):
    ...
    def formula_2007(foyer_fiscal, period, parameters):
        ...
        ecodev = parameters(
            period
        ).impot_revenu.charges_deductibles.compte_epargne_codev
...
class grosses_reparations(Variable):
    ...
    def formula_2009(foyer_fiscal, period, parameters):
        ...
        f6cb = foyer_fiscal("f6cb", period)
        plafond_grosses_reparations = parameters(
            period
        ).impot_revenu.charges_deductibles.grosses_reparations.plafond
    ...
    def formula_2014(foyer_fiscal, period, parameters):
        ...
        depenses_courantes = f6cb
        report_depenses = (
            report_2009 + report_2010 + report_2011 + report_2012 + report_2013
        )
