...
class f7ac(Variable):
    cerfa_field = {0: u"7AC", 1: u"7AE", 2: u"7AG"}
    value_type = int
    unit = "currency"
    entity = Individu
...
class f7rc(Variable):
    ...
    entity = FoyerFiscal
    label = (
        u"Travaux de restauration immobilière dans un secteur sauvegardé ou assimilé"
    )
    #    start_date = date(2011, 1, 1)
    definition_period = YEAR
...
class f7ut(Variable):
    ...
    entity = FoyerFiscal
    label = (
        u"Investissements forestiers : indicatrice travaux consécutifs à un sinistre"
    )
    #    start_date = date(2009, 1, 1)
    definition_period = YEAR
...
class f7ek(Variable):
    ...
    entity = FoyerFiscal
    label = (
        u"Investissements locatifs intermÃ©diaires du 1.1 au 31.8.2014 en mÃ©tropole"
    )
    #    start_date = date(2014, 1, 1)
    definition_period = YEAR
...
class f8wd(Variable):
    ...
    entity = FoyerFiscal
    label = (
        u"Crédit d'impôt en faveur des entreprises: Formation des chefs d'entreprise"
    )
    #    start_date = date(2006, 1, 1)
    definition_period = YEAR
