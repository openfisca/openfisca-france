...
class rag1_ci_etr(Variable):
    ...
    unit = 'currency'
    entity = Individu
    label = "Revenus de source étrangère avec crédit d’impôt égal à l’impôt français - Revenus agricoles - OGA/Viseur"
    # start_date = date(2016, 1, 1)
    definition_period = YEAR
...
class rag2_ci_etr(Variable):
    ...
    unit = 'currency'
    entity = Individu
    label = "Revenus de source étrangère avec crédit d’impôt égal à l’impôt français - Revenus agricoles - Sans"
    # start_date = date(2016, 1, 1)
    definition_period = YEAR
...
class ricpro1_ci_etr(Variable):
    ...
    unit = 'currency'
    entity = Individu
    label = "Revenus de source étrangère avec crédit d’impôt égal à l’impôt français - RIC pro - OGA/Viseur"
    # start_date = date(2016, 1, 1)
    definition_period = YEAR
...
class ricpro2_ci_etr(Variable):
    ...
    unit = 'currency'
    entity = Individu
    label = "Revenus de source étrangère avec crédit d’impôt égal à l’impôt français - RIC Pro - Sans"
    # start_date = date(2016, 1, 1)
    definition_period = YEAR
...
class ricnpro1_ci_etr(Variable):
    ...
    unit = 'currency'
    entity = Individu
    label = "Revenus de source étrangère avec crédit d’impôt égal à l’impôt français - RIC non-pro - OGA/Viseur"
    # start_date = date(2016, 1, 1)
    definition_period = YEAR
...
class ricnpro2_ci_etr(Variable):
    ...
    unit = 'currency'
    entity = Individu
    label = "Revenus de source étrangère avec crédit d’impôt égal à l’impôt français - RIC non-pro - Sans"
    # start_date = date(2016, 1, 1)
    definition_period = YEAR
...
class locmeu1_ci_etr(Variable):
    ...
    unit = 'currency'
    entity = Individu
    label = "Revenus de source étrangère avec crédit d’impôt égal à l’impôt français - Location meublée non-pro - OGA/Viseur"
    # start_date = date(2016, 1, 1)
    definition_period = YEAR
...
class locmeu2_ci_etr(Variable):
    ...
    unit = 'currency'
    entity = Individu
    label = "Revenus de source étrangère avec crédit d’impôt égal à l’impôt français - Location meublée non-pro - Sans"
    # start_date = date(2016, 1, 1)
    definition_period = YEAR
...
class rncpro1_ci_etr(Variable):
    ...
    unit = 'currency'
    entity = Individu
    label = "Revenus de source étrangère avec crédit d’impôt égal à l’impôt français - RNC pro - OGA/Viseur"
    # start_date = date(2016, 1, 1)
    definition_period = YEAR
...
class rncpro2_ci_etr(Variable):
    ...
    unit = 'currency'
    entity = Individu
    label = "Revenus de source étrangère avec crédit d’impôt égal à l’impôt français - RNC pro - Sans"
    # start_date = date(2016, 1, 1)
    definition_period = YEAR
...
class rncnpro1_ci_etr(Variable):
    ...
    unit = 'currency'
    entity = Individu
    label = "Revenus de source étrangère avec crédit d’impôt égal à l’impôt français - RNC non-pro - OGA/Viseur"
    # start_date = date(2016, 1, 1)
    definition_period = YEAR
...
class rncnpro2_ci_etr(Variable):
    ...
    unit = 'currency'
    entity = Individu
    label = "Revenus de source étrangère avec crédit d’impôt égal à l’impôt français - RNC non-pro - Sans"
    # start_date = date(2016, 1, 1)
    definition_period = YEAR
...
class mfonc_ci_etr(Variable):
    ...
    unit = 'currency'
    entity = FoyerFiscal
    label = "Revenus de source étrangère avec crédit d’impôt égal à l’impôt français - Micro-foncier"
    # start_date = date(2016, 1, 1)
    definition_period = YEAR
...
class afonc_ci_etr(Variable):
    ...
    unit = 'currency'
    entity = FoyerFiscal
    label = "Revenus de source étrangère avec crédit d’impôt égal à l’impôt français - Revenus foncier régime du bénéfice réel"
    # start_date = date(2016, 1, 1)
    definition_period = YEAR
