...
class chomage_cotisation_retraite_complementaire_journaliere(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        taux_cotisation = parameters(period).prelevements_sociaux.regimes_complementaires_retraite_secteur_prive.cotisation_retraite_complementaire.employeur.cotisation_retraite_complementaire.taux
