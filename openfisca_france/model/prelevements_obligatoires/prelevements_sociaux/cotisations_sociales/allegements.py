...
class coefficient_proratisation(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        duree_legale_mensuelle = parameters.marche_travail.salaire_minimum.nb_heure_travail_mensuel
...
class smic_proratise(Variable):
    ...
    def formula(individu, period, parameters):
        coefficient_proratisation = individu('coefficient_proratisation', period)
        smic_horaire_brut = parameters(period).marche_travai.salaire_minimum.smic_h_b
