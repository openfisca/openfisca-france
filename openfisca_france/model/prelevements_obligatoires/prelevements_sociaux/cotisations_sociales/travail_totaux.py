...
class cotisations_employeur(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        cotisations_employeur_main_d_oeuvre = individu(
            "cotisations_employeur_main_d_oeuvre", period
        )
...
class cotisations_employeur_contributives(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        fonds_emploi_hospitalier = individu(
            "fonds_emploi_hospitalier", period, options=[ADD]
        )
        ircantec_employeur = individu("ircantec_employeur", period, options=[ADD])
        pension_civile_employeur = individu(
            "pension_civile_employeur", period, options=[ADD]
        )
        rafp_employeur = individu("rafp_employeur", period, options=[ADD])
        vieillesse_deplafonnee_employeur = individu(
            "vieillesse_deplafonnee_employeur", period, options=[ADD]
        )
        vieillesse_plafonnee_employeur = individu(
            "vieillesse_plafonnee_employeur", period, options=[ADD]
        )
...
class cotisations_employeur_non_contributives(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        allocations_temporaires_invalidite = individu(
            "allocations_temporaires_invalidite", period, options=[ADD]
        )
...
class cotisations_salariales_contributives(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        cotisation_exceptionnelle_temporaire_salarie = individu(
            "cotisation_exceptionnelle_temporaire_salarie", period, options=[ADD]
        )
        ircantec_salarie = individu("ircantec_salarie", period, options=[ADD])
        pension_civile_salarie = individu(
            "pension_civile_salarie", period, options=[ADD]
        )
        rafp_salarie = individu("rafp_salarie", period, options=[ADD])
        vieillesse_deplafonnee_salarie = individu(
            "vieillesse_deplafonnee_salarie", period, options=[ADD]
        )
        vieillesse_plafonnee_salarie = individu(
            "vieillesse_plafonnee_salarie", period, options=[ADD]
        )
...
class cotisations_salariales_non_contributives(Variable):
    ...
    def formula(individu, period, parameters):
        contribution_exceptionnelle_solidarite = individu(
            "contribution_exceptionnelle_solidarite", period, options=[ADD]
        )
...
class cotisations_salariales(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        exoneration_cotisations_salariales_apprenti = individu(
            "exoneration_cotisations_salariales_apprenti", period, options=[ADD]
        )
        exoneration_cotisations_salarie_stagiaire = individu(
            "exoneration_cotisations_salarie_stagiaire", period, options=[ADD]
        )
