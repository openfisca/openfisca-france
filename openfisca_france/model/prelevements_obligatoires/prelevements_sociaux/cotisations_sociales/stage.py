...
class stage_gratification(Variable):
    ...
    def formula_2014_11(individu, period, parameters):
        ...
        plafond_securite_sociale_horaire = parameters(
            period
        ).cotsoc.gen.plafond_securite_sociale_horaire
        stage_gratification_taux_min = parameters(
            period
        ).cotsoc.stage.taux_gratification_min
        return (
            stagiaire
            * plafond_securite_sociale_horaire
            * stage_duree_heures
            * max_(stage_gratification_taux, stage_gratification_taux_min)
        )
...
class stage_gratification_reintegration(Variable):
    ...
    def formula_2014_11(individu, period, parameters):
        ...
        stage_gratification_min = (
            plafond_securite_sociale_horaire
            * stage_duree_heures
            * stage_gratification_taux_min
        )
