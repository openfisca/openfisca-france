...
class forfait_social(Variable):
    ...
    def formula_2009_01_01(individu, period, parameters):
        prise_en_charge_employeur_retraite_complementaire = individu(
            "prise_en_charge_employeur_retraite_complementaire", period, options=[ADD]
        )
...
class salaire_imposable(Variable):
    ...
    def formula(individu, period):
        ...
        rev_microsocial = individu.foyer_fiscal(
            "rev_microsocial", period, options=[DIVIDE]
        )
        rev_microsocial_declarant1 = rev_microsocial * individu.has_role(
...
class tehr(Variable):
    ...
    reference = (
        u"http://vosdroits.service-public.fr/professionnels-entreprises/F32096.xhtml"
    )
    ...
    def formula(individu, period, parameters):
        salaire_de_base = individu(
            "salaire_de_base", period, options=[ADD]
        )  # TODO: check base
        law = parameters(period)
...
class rev_microsocial(Variable):
    ...
    def formula_2009_01_01(foyer_fiscal, period, parameters):
        ...
        prelsoc_ms = (
            assiette_service * P.servi
            + assiette_vente * P.vente
            + assiette_proflib * P.rsi
        )
