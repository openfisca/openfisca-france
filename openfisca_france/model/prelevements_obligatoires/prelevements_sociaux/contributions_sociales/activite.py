...
class forfait_social(Variable):
    ...
    def formula_2009_01_01(individu, period, parameters):
        ...
        parametres = parameters(period).prelevements_sociaux.contributions_assises_accessoires_salaire.forfait_social
...
class tehr(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        bareme_tehr = parameters(period).prelevements_sociaux.autres_taxes_salaires.tehr.tehr
