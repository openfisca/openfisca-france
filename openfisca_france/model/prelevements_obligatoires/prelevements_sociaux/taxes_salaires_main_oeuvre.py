...
class conge_individuel_formation_cdd(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        conge_individuel_formation = parameters(period).prelevements_sociaux.autres_taxes_salaires.formation.toute_entreprise
...
class contribution_supplementaire_apprentissage(Variable):
    ...
    def formula_2015_01_01(individu, period, parameters):
        ...
        contribution = parameters(period).prelevements_sociaux.autres_taxes_salaires.apprentissage.csa
...
class taxe_salaires(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        taxe_salaires = parameters(period).prelevements_sociaux.autres_taxes_salaires.taxsal
