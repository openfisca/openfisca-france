...
CURRENCY = u"€"
REVENUES_CATEGORIES = {
    'brut': ['salbrut', 'salaire_de_base', 'chobrut', 'rstbrut', 'alr', 'pensions_alim_versees', 'rev_cap_brut', 'fon'],
    'imposable': ['sal', 'cho', 'rst', 'alr', 'pensions_alim_versees', 'rev_cap_brut', 'fon', 'cotsoc_cap'],
    'net': ['salaire_net', 'chonet', 'rstnet', 'alr', 'pensions_alim_versees', 'rev_cap_net', 'fon'],
    'superbrut': ['salsuperbrut', 'chobrut', 'rstbrut', 'alr', 'pensions_alim_versees', 'rev_cap_brut', 'fon'],
    }
