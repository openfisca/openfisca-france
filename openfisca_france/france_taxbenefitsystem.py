...
class FranceTaxBenefitSystem(TaxBenefitSystem):
    ...
    REVENUES_CATEGORIES = {
        'brut': ['salaire_brut', 'chomage_brut', 'retraite_brute', 'pensions_alimentaires_percues', 'pensions_alimentaires_versees', 'rev_cap_brut', 'revenus_fonciers_nets_abattement_microfoncier'],
        'imposable': ['salaire_imposable', 'chomage_imposable', 'retraite_imposable', 'pensions_alimentaires_percues', 'pensions_alimentaires_versees', 'rev_cap_brut', 'revenus_fonciers_nets_abattement_microfoncier', 'prelevements_sociaux_revenus_capital'],
        'net': ['salaire_net', 'chomage_net', 'retraite_nette', 'pensions_alimentaires_percues', 'pensions_alimentaires_versees', 'rev_cap_net', 'revenus_fonciers_nets_abattement_microfoncier'],
        'superbrut': ['salaire_super_brut', 'chomage_brut', 'retraite_brute', 'pensions_alimentaires_percues', 'pensions_alimentaires_versees', 'rev_cap_brut', 'revenus_fonciers_nets_abattement_microfoncier'],
        }
