...
class salaire_de_base(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        taux_csg = parameters(
            period
        ).prelevements_sociaux.contributions.csg.activite.deductible.taux * (1 - .0175)
...
class traitement_indiciaire_brut(Variable):
    ...
    def formula(individu, period, parameters):
        ...
        bareme_prime.add_bracket(
            0, -TAUX_DE_PRIME
        )  # barème équivalent à taux_prime*TIB
