...
def counterfactual_2014_modify_parameters(parameters):
    ...
    parameters.impot_revenu.bareme_ir_depuis_1945.bareme_ir_depuis_1945.bareme[1].threshold.update(period = reform_period, value = 6011 * inflator)
    parameters.impot_revenu.bareme_ir_depuis_1945.bareme_ir_depuis_1945.bareme[1].rate.update(period = reform_period, value = .055 * inflator)
    parameters.impot_revenu.bareme_ir_depuis_1945.bareme_ir_depuis_1945.bareme[2].threshold.update(period = reform_period, value = 11991 * inflator)
    parameters.impot_revenu.bareme_ir_depuis_1945.bareme_ir_depuis_1945.bareme[2].rate.update(period = reform_period, value = .14 * inflator)
    parameters.impot_revenu.bareme_ir_depuis_1945.bareme_ir_depuis_1945.bareme[3].threshold.update(period = reform_period, value = 26631 * inflator)
    parameters.impot_revenu.bareme_ir_depuis_1945.bareme_ir_depuis_1945.bareme[3].rate.update(period = reform_period, value = .30 * inflator)
    parameters.impot_revenu.bareme_ir_depuis_1945.bareme_ir_depuis_1945.bareme[4].threshold.update(period = reform_period, value = 71397 * inflator)
    parameters.impot_revenu.bareme_ir_depuis_1945.bareme_ir_depuis_1945.bareme[4].rate.update(period = reform_period, value = .40 * inflator)
