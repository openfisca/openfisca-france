...
def modify_parameters(parameters):
    ...
    parameters.impot_revenu.bareme_ir_depuis_1945.bareme_ir_depuis_1945.bareme[1].rate.update(period=reform_period, value=0)
    parameters.impot_revenu.bareme_ir_depuis_1945.bareme_ir_depuis_1945.bareme[2].threshold.update(period=reform_period, value=9690)
