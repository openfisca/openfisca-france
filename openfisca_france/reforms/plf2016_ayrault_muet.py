...
def ayrault_muet_modify_parameters(parameters):
    ...
    elig1 = Parameter(
        ...
        {
            "values": {
                "2015-01-01": {"value": round(16251 * inflator)},
    ...
    elig2 = Parameter(
        ...
        {
            "values": {
                "2015-01-01": {"value": round(32498 * inflator)},
                "2016-01-01": {"value": None},
            }
        },
    )
    elig3 = Parameter(
        ...
        {
            "values": {
                "2015-01-01": {"value": round(4490 * inflator)},
                "2016-01-01": {"value": None},
            }
        },
    )
...
class reduction_csg(Variable):
    ...
    def formula_2015_01_01(individu, period, parameters):
        ...
        taux_allegement_csg = tx_max * min_(
            1, max_(seuil - 1 / ratio_smic_salaire, 0) / (seuil - 1)
        )
