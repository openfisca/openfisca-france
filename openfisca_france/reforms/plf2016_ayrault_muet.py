...
class ayrault_muet(Reform):
    ...
    def apply(self):
        for variable in [self.reduction_csg, self.regularisation_reduction_csg, self.reduction_csg_foyer_fiscal,
                self.reduction_csg_nette, self.ppe_elig_bis, self.ppe_elig_bis_individu, self.variator]:
