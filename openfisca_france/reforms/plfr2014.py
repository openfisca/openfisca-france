...
def modify_parameters(parameters):
    ...
    plfr2014_parameters_subtree = load_parameter_file(
        name="plfr2014", file_path=file_path
    )

    file_path = os.path.join(dir_path, "plfrss2014.yaml")
    plfrss2014_parameters_subtree = load_parameter_file(
