...
class InputTable(ModelDescription):
    ...
    # Revenus agricoles: Régime du forfait
    f5hn = IntCol(entity= 'foy', label=u"Revenus exonérés", val_type="monetary") # Revenus 2012
    f5ho = IntCol(entity= 'foy', label=u"Revenus imposables", val_type="monetary") # Revenus 2012
    f5hd = IntCol(entity= 'foy', label=u"Revenus des exploitants forestiers", val_type="monetary") # Revenus 2012
    f5hw = IntCol(entity= 'foy', label=u"Plus-values à court terme", val_type="monetary") # Revenus 2012
    f5hx = IntCol(entity= 'foy', label=u"Plus-values de cession taxables à 16%", val_type="monetary") # Revenus 2012
       
    # Revenus agricoles: Régime du bénéfice réel, revenus bénéficiant de l'abattement CGA ou viseur
    f5hb = IntCol(entity= 'foy', label=u"Revenus exonérés yc plus-values, activités exercées en Corse", val_type="monetary") # Revenus 2012
    f5hc = IntCol(entity= 'foy', label=u"Revenus imposables, cas général moyenne triennale", val_type="monetary") # Revenus 2012
    f5he = IntCol(entity= 'foy', label=u"Plus-values de cession taxables à 16%", val_type="monetary") # Revenus 2012
    f5hf = IntCol(entity= 'foy', label=u"Déficits", val_type="monetary") # Revenus 2012
    f5hm = IntCol(entity= 'foy', label=u"Jeunes agriculteurs, Abattement de 50% ou 100%", val_type="monetary") # Revenus 2012
       
    # Revenus agricoles: Régime du bénéfice réel, revenus ne bénéficiant pas de l'abattement CGA ou viseur
    f5hh = IntCol(entity= 'foy', label=u"Revenus exonérés yc plus-values, activités exercées en Corse", val_type="monetary") # Revenus 2012
    f5hi = IntCol(entity= 'foy', label=u"Revenus imposables, cas général moyenne triennale", val_type="monetary") # Revenus 2012
    f5hl = IntCol(entity= 'foy', label=u"Déficits", val_type="monetary") # Revenus 2012
    f5hz = IntCol(entity= 'foy', label=u"Jeunes agriculteurs, Abattement de 50% ou 100%", val_type="monetary") # Revenus 2012
     
    # Déficits agricoles des années antérieures du foyer
    f5qf = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2006", val_type="monetary") # Revenus 2012
    f5qg = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2007", val_type="monetary") # Revenus 2012
    f5qn = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2008", val_type="monetary") # Revenus 2012
    f5qo = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2009", val_type="monetary") # Revenus 2012
    f5qp = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2010", val_type="monetary") # Revenus 2012
    f5qq = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2011", val_type="monetary") # Revenus 2012
          
       
    # Revenus industriels et commerciaux professionnels: régime micro entreprise
    f5kn = IntCol(entity= 'foy', label=u"Revenus nets exonérés", val_type="monetary") # Revenus 2012
    f5ko = IntCol(entity= 'foy', label=u"Revenus imposables: vente de marchandises", val_type="monetary") # Revenus 2012
    f5kp = IntCol(entity= 'foy', label=u"Revenus imposables: prestations de services et locations meublées", val_type="monetary") # Revenus 2012
    f5kx = IntCol(entity= 'foy', label=u"Plus-values imposables: plus-values nettes à court terme", val_type="monetary") # Revenus 2012
    f5kq = IntCol(entity= 'foy', label=u"Plus-values imposables: plus-values de cession taxables à 16%", val_type="monetary") # Revenus 2012
    f5kr = IntCol(entity= 'foy', label=u"Moins-values à long terme", val_type="monetary") # Revenus 2012
    f5kj = IntCol(entity= 'foy', label=u"Moins-values nettes à court terme", val_type="monetary") # Revenus 2012
    
    # Revenus industriels et commerciaux professionnels: régime du bénéfice réel
    f5kb = IntCol(entity= 'foy', label=u"Revenus nets exonérés yc plus-values avec CGA ou viseur", val_type="monetary") # Revenus 2012
    f5kh = IntCol(entity= 'foy', label=u"Revenus nets exonérés yc plus-values sans CGA", val_type="monetary") # Revenus 2012
    f5kc = IntCol(entity= 'foy', label=u"Revenus imposables: régime normal ou simplifié avec CGA ou viseur", val_type="monetary") # Revenus 2012
    f5ki = IntCol(entity= 'foy', label=u"Revenus imposables: régime normal ou simplifié sans CGA", val_type="monetary") # Revenus 2012
    f5ha = IntCol(entity= 'foy', label=u"Revenus imposables: locations meublées avec CGA ou viseur", val_type="monetary") # Revenus 2012
    f5ka = IntCol(entity= 'foy', label=u"Revenus imposables: locations meublées sans CGA", val_type="monetary") # Revenus 2012
    f5ke = IntCol(entity= 'foy', label=u"Plus-values de cession taxables à 16% avec CGA ou viseur", val_type="monetary") # Revenus 2012
    f5kf = IntCol(entity= 'foy', label=u"Déficits: régime normal ou simplifié avec CGA ou viseur", val_type="monetary") # Revenus 2012      
    f5kl = IntCol(entity= 'foy', label=u"Déficits: régime normal ou simplifié sans CGA", val_type="monetary") # Revenus 2012
    f5qa = IntCol(entity= 'foy', label=u"Déficits: locations meublées avec CGA ou viseur", val_type="monetary") # Revenus 2012
    f5qj = IntCol(entity= 'foy', label=u"Déficits: locations meublées sans CGA", val_type="monetary") # Revenus 2012
    f5ks = IntCol(entity= 'foy', label=u"Artisans pêcheurs : abattement 50% avec CGA ou viseur", val_type="monetary") # Revenus 2012

    # Revenus industriels et commerciaux non professionnels: régime micro entreprise
    f5nn = IntCol(entity= 'foy', label=u"Revenus nets exonérés", val_type="monetary") # Revenus 2012
    f5no = IntCol(entity= 'foy', label=u"Revenus imposables: vente de marchandises et assimilées", val_type="monetary") # Revenus 2012
    f5np = IntCol(entity= 'foy', label=u"Revenus imposables: prestations de services", val_type="monetary") # Revenus 2012
    f5nx = IntCol(entity= 'foy', label=u"Plus-values imposables: plus-values nettes à court terme", val_type="monetary") # Revenus 2012
    f5nq = IntCol(entity= 'foy', label=u"Plus-values imposables: plus-values de cession taxables à 16%", val_type="monetary") # Revenus 2012
    f5nr = IntCol(entity= 'foy', label=u"Moins-values à long terme", val_type="monetary") # Revenus 2012
    f5iu = IntCol(entity= 'foy', label=u"Moins-values nettes à court terme du foyer", val_type="monetary") # Revenus 2012
    
    
    # Revenus industriels et commerciaux non professionnels: régime du bénéfice réel
    f5nb = IntCol(entity= 'foy', label=u"Revenus exonérés yc plus-values avec CGA ou viseur", val_type="monetary") # Revenus 2012
    f5nh = IntCol(entity= 'foy', label=u"Revenus exonérés yc plus-values sans CGA", val_type="monetary") # Revenus 2012
    f5nc = IntCol(entity= 'foy', label=u"Revenus imposables: régime normal ou simplifié avec CGA ou viseur", val_type="monetary") # Revenus 2012
    f5ni = IntCol(entity= 'foy', label=u"Revenus imposables: régime normal ou simplifié sans CGA", val_type="monetary") # Revenus 2012
    f5ne = IntCol(entity= 'foy', label=u"Plus-values de cession taxables à 16% avec CGA ou viseur", val_type="monetary") # Revenus 2012
    f5nf = IntCol(entity= 'foy', label=u"Déficits: régime normal ou simplifié avec CGA ou viseur", val_type="monetary") # Revenus 2012      
    f5nl = IntCol(entity= 'foy', label=u"Déficits: régime normal ou simplifié sans CGA", val_type="monetary") # Revenus 2012
    
    
    # Déficits industriels et commerciaux non professionnels des années antérieures non encore déduits
    f5rn = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2006", val_type="monetary") # Revenus 2012
    f5ro = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2007", val_type="monetary") # Revenus 2012
    f5rp = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2008", val_type="monetary") # Revenus 2012
    f5rq = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2009", val_type="monetary") # Revenus 2012
    f5rr = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2010", val_type="monetary") # Revenus 2012
    f5rw = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2011", val_type="monetary") # Revenus 2012
    
    # Locations meublées non professionnelles: régime micro entreprise
    f5nd = IntCol(entity= 'foy', label=u"Locations meublées", val_type="monetary") # Revenus 2012
    f5ng = IntCol(entity= 'foy', label=u"Location de gîtes ruraux, chambres d'hôtes et meublés de tourisme", val_type="monetary") # Revenus 2012
    f5nj = IntCol(entity= 'foy', label=u"Locations déjà soumises aux prélèvements sociaux", val_type="monetary") # Revenus 2012
    
    
    # Locations meublées non professionnelles: régime du bénéfice réel
    f5na = IntCol(entity= 'foy', label=u"Revenus imposables avec CGA ou viseur", val_type="monetary") # Revenus 2012
    f5nk = IntCol(entity= 'foy', label=u"Revenus imposables sans CGA", val_type="monetary") # Revenus 2012
    f5nm = IntCol(entity= 'foy', label=u"Locations déjà soumises aux prélèvements sociaux avec CGA ou viseur", val_type="monetary") # Revenus 2012
    f5km = IntCol(entity= 'foy', label=u"Locations déjà soumises aux prélèvements sociauxsans CGA", val_type="monetary") # Revenus 2012
    f5ny = IntCol(entity= 'foy', label=u"Déficits avec CGA ou viseur", val_type="monetary") # Revenus 2012      
    f5nz = IntCol(entity= 'foy', label=u"Déficits sans CGA", val_type="monetary") # Revenus 2012
    
    
    # Déficits locations meublées non professionnelles des années antérieures non encore déduits
    f5ga = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2002", val_type="monetary") # Revenus 2012
    f5gb = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2003", val_type="monetary") # Revenus 2012
    f5gc = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2004", val_type="monetary") # Revenus 2012
    f5gd = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2005", val_type="monetary") # Revenus 2012  
    f5ge = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2006", val_type="monetary") # Revenus 2012
    f5gf = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2007", val_type="monetary") # Revenus 2012
    f5gg = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2008", val_type="monetary") # Revenus 2012
    f5gh = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2009", val_type="monetary") # Revenus 2012
    f5gi = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2010", val_type="monetary") # Revenus 2012
    f5gj = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2011", val_type="monetary") # Revenus 2012
 
    
    # Revenus non comerciaux professionnels: régime déclaratif spécial ou micro BNC
    f5hp = IntCol(entity= 'foy', label=u"Revenus nets exonérés", val_type="monetary") # Revenus 2012
    f5hq = IntCol(entity= 'foy', label=u"Revenus imposables", val_type="monetary") # Revenus 2012
    f5hv = IntCol(entity= 'foy', label=u"Plus-values imposables et Plus-values nettes à court terme ", val_type="monetary") # Revenus 2012
    f5hr = IntCol(entity= 'foy', label=u"Plus-values de cession taxables à 16%", val_type="monetary") # Revenus 2012
    f5hs = IntCol(entity= 'foy', label=u"Moins-values à long terme", val_type="monetary") # Revenus 2012      
    f5kz = IntCol(entity= 'foy', label=u"Moins-values nettes à court terme", val_type="monetary") # Revenus 2012
    
    # Revenus non comerciaux professionnels: régime de la déclaration controlée. Revenus bénéficiant de l'abattement association agrée ou viseur
    f5qb = IntCol(entity= 'foy', label=u"Revenus exonérés (yc compris plus-values)", val_type="monetary") # Revenus 2012
    f5qc = IntCol(entity= 'foy', label=u"Revenus imposables", val_type="monetary") # Revenus 2012
    f5qd = IntCol(entity= 'foy', label=u"Plus-values de cession taxables à 16%", val_type="monetary") # Revenus 2012
    f5qe = IntCol(entity= 'foy', label=u"Déficits", val_type="monetary") # Revenus 2012
    f5ql = IntCol(entity= 'foy', label=u"Jeunes créateurs abattement 50%", val_type="monetary") # Revenus 2012      
    f5tf = IntCol(entity= 'foy', label=u"Honoraires de prospection commerciale éxonérés", val_type="monetary") # Revenus 2012
      
    # Revenus non comerciaux professionnels: régime de la déclaration controlée. Revenus ne bénéficiant pas de l'abattement association agrée
    f5qh = IntCol(entity= 'foy', label=u"Revenus exonérés (yc compris plus-values)", val_type="monetary") # Revenus 2012
    f5qi = IntCol(entity= 'foy', label=u"Revenus imposables", val_type="monetary") # Revenus 2012
    f5qk = IntCol(entity= 'foy', label=u"Déficits", val_type="monetary") # Revenus 2012      
    f5ti = IntCol(entity= 'foy', label=u"Honoraires de prospection commerciale éxonérés", val_type="monetary") # Revenus 2012
 
    # Revenus non comerciaux professionnels: agents généraux d'assurance
    f5qm = IntCol(entity= 'foy', label=u"Indemnité de cessation d'activité", val_type="monetary") # Revenus 2012
    
    # Revenus non comerciaux non professionnels: régime déclaratif spécial ou micro BNC
    f5th = IntCol(entity= 'foy', label=u"Revenus nets exonérés", val_type="monetary") # Revenus 2012
    f5ku = IntCol(entity= 'foy', label=u"Revenus imposables", val_type="monetary") # Revenus 2012
    f5ky = IntCol(entity= 'foy', label=u"Plus-values imposables et plus-values nettes à court terme", val_type="monetary") # Revenus 2012
    f5kv = IntCol(entity= 'foy', label=u"Plus-values de cession taxables à 16%", val_type="monetary") # Revenus 2012
    f5kw = IntCol(entity= 'foy', label=u"Moins-values à long terme", val_type="monetary") # Revenus 2012      
    f5ju = IntCol(entity= 'foy', label=u"Moins-values nettes à court terme du foyer", val_type="monetary") # Revenus 2012
    
    # Revenus non comerciaux non professionnels: régime de la déclaration controlée
    f5hk = IntCol(entity= 'foy', label=u"Revenus exonérés avec AA ou viseur", val_type="monetary") # Revenus 2012  
    f5ik = IntCol(entity= 'foy', label=u"Revenus exonérés sans AA", val_type="monetary") # Revenus 2012  
    f5jg = IntCol(entity= 'foy', label=u"Revenus imposables avec AA ou viseur", val_type="monetary") # Revenus 2012
    f5sn = IntCol(entity= 'foy', label=u"Revenus imposables sans AA", val_type="monetary") # Revenus 2012
    f5so = IntCol(entity= 'foy', label=u"Plus-values taxables à 16% avec AA ou viseur", val_type="monetary") # Revenus 2012
    f5jj = IntCol(entity= 'foy', label=u"Déficits avec AA ou viseur", val_type="monetary") # Revenus 2012    
    f5sp = IntCol(entity= 'foy', label=u"Déficits sans AA", val_type="monetary") # Revenus 2012
    f5tc = IntCol(entity= 'foy', label=u"Inventeurs et auteurs de logiciels: produits taxables à 16% avec AA ou viseur", val_type="monetary") # Revenus 2012      
    f5sv = IntCol(entity= 'foy', label=u"Jeunes créateurs: abattement de 50 % avec AA ou viseur", val_type="monetary") # Revenus 2012
    
    # Déficits non commerciaux non professionnels des années antérieures non encore déduits
    f5ht = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2006", val_type="monetary") # Revenus 2012
    f5it = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2007", val_type="monetary") # Revenus 2012
    f5jt = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2008", val_type="monetary") # Revenus 2012
    f5kt = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2009", val_type="monetary") # Revenus 2012
    f5lt = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2010", val_type="monetary") # Revenus 2012
    f5mt = IntCol(entity= 'foy', label=u"Déficits des années antérieures non encore déduits: 2011", val_type="monetary") # Revenus 2012

    # Auto-entrepreneur ayant opté pour le versement libératoire de l'impôt sur le revenu
    f5ta = IntCol(entity= 'foy', label=u"Revenus industriels et commerciaux: Vente de marchandises et assimilées", val_type="monetary") # Revenus 2012
    f5tb = IntCol(entity= 'foy', label=u"Revenus industriels et commerciaux: Prestations de services et locations meublées", val_type="monetary") # Revenus 2012 
    f5te = IntCol(entity= 'foy', label=u"Revenus non commerciaux: recettes brutes", val_type="monetary") # Revenus 2012
    
    # Revenus à imposer aux prélèvements sociaux
    f5hy = IntCol(entity= 'foy', label=u"Revenus nets", val_type="monetary") # Revenus 2012
    f5hg = IntCol(entity= 'foy', label=u"Plus-values à long terme éxonérées en cas de départ à la retraite", val_type="monetary") # Revenus 2012 
