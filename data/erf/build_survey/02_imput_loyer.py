...
# table(erf$iaat, useNA="ifany") 
    ...
    Lgtmen.fillna(axis = ['mrcho','mrret','mrsal','mrtns'],value = 0) # TODO : fillna marche rarement
    ...
    dec, values = mark_weighted_percentiles(Lgtmen['nvpr'],arange(1,11),
                                    Lgtmen['qex'],2,return_quantiles=True) 
    dec = DataFrame(dec)
