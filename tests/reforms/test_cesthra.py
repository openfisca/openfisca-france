...
def test_cesthra_invalidee():
    ...
    scenario = reform.new_scenario().init_single_entity(
        axes=[dict(count=10, max=30000, min=0, name="salaire_imposable")],
        period=period,
    ...
    reference_revenu_disponible = reference_simulation.calculate(
    ...
    reform_revenu_disponible = reform_simulation.calculate(
        "revenu_disponible", period=period
    )
